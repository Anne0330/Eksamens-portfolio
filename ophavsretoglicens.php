...
<html lang="da">
    <head>
        ...
        <link rel="stylesheet" href="ophavsretoglicenscss.css">
    ...
    <header>
        <h1>Ophavsret og Licens</h1>
        
        <div id="introtekst">
             <p>Her kan du læse om opahsvret og licens, da det er vigtigt at vide reglerne, som indgår inde for alle kreationer der er lavet. Det giver en overvejelse på hvorvidt en må ’låne’ et billede til reklame, eller et stykke musik fra internettet. Når en multimediedesigner er så vidt omkring i de forskellige emner og arbejdsfordelinger, specielt indenfor reklame og produktion af et website, er det vigtigt at kunne vide hvilket materiale der må bruges.</p>
        </div>
    </header>
...
<section><!--indhold-->      
        ...
        <div id="pdf">
            ...
            <h3>Opgave</h3>
            <p>Har skrevet en opgave omkring ophavsret og licens, hvor det er studeret og skrevet med multimediedesigner's perspektiv, der er vedhæftet nedenfor som en pdf fil.</p>
        </div>
